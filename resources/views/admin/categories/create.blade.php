...
<div class="container mx-auto py-8 max-w-3xl">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.categories.store') }}" class="p-6 md:p-8 space-y-6">
            @csrf

            <div>
                <label class="block mb-2 text-sm font-semibold text-gray-700">Category Title <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block mb-2 text-sm font-semibold text-gray-700">Category Image</label>
